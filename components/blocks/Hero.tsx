      ...
      <Container>
        ...
        >
          <div className={`${styles.contentWrapper} ${contentClass}`}>
            {preheading && (
              <p className={styles.preheading} data-aos='fade-down'>
                {preheading}
              </p>
            )}
            {title && (
            ...
            <div
              ...
              data-aos-delay='300'
            >
              <Button text={'View portfolio'} url={'/portfolio'} />
            </div>
            <div className={styles.textBox} data-aos='fade-up'>
              <p className='text-3xl font-medium'>
                6<span className={styles.textBoxCharacter}>+</span>
              </p>
...
const styles = {
  ...
  preheading: 'mb-5 px-4 py-2 bg-violet-light inline-block text-violet rounded',
  title: 'mb-6',
  content: 'mb-8',
  buttonWrapper: 'mb-8',
  image:
