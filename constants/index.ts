...
export const portfolios = [
  ...
  {
    id: 4,
    title: 'Together Dates - Relationship Milestone App',
    description: 'Vibe coded with Lovable (AI-powered app builder)',
    link: 'https://togetherdates.com/',
    image: '/images/togetherdates-mockups.png',
  },
  {
    id: 5,
