...
export const timeline = [
  {
    ...
    description: [
      'Implementing new features and bug fixes for a headless e-commerce site using Next.js, React, and Magento',
      'Developing a headless website built with Next.js, React and Builder.io',
      'Working on a large-scale Svelte + Builder.io monorepo project',
      'Collaborating with QA testers and participating in code reviews',
      'Working with Next.js, React, Magento, Builder.io, Svelte, TypeScript, Tailwind, GraphQL',
    ],
  },
  {
    id: 2,
